<?php
  ...
  if($page_count > 1)
  {
    ...
    <div class="tablenav"<?php echo (isset($navstyle)?" style=\"$navstyle\"":''); ?>>
      <?php do_action('affli-link-list-actions', $footer); ?>
      <div class='tablenav-pages'><span class="displaying-num">Displaying <?php print "$page_first_record&#8211;$page_last_record of $record_count"; ?></span>
        ...
        {
          ?>
          <a class='prev page-numbers' href='?page=<?php print AFLI_PLUGIN_NAME; ?>/<?php print $controller_file . $page_params; ?>&paged=<?php print($current_page-1); ?>'>&laquo;</a>
          <?php
        }
        ...
        {
          ?>
          <a class='page-numbers' href='?page=<?php print AFLI_PLUGIN_NAME; ?>/<?php print $controller_file . $page_params; ?>&paged=1'>1</a>
          <?php
        }
        ...
        for($i = $low_page; $i <= $high_page; $i++)
        {
          ...
          {
            ?>
            <a class='page-numbers' href='?page=<?php print AFLI_PLUGIN_NAME; ?>/<?php print $controller_file . $page_params; ?>&paged=<?php print $i; ?>'><?php print $i; ?></a>
            <?php
          }
        }
        ...
        {
          ?>
          <a class='page-numbers' href='?page=<?php print AFLI_PLUGIN_NAME; ?>/<?php print $controller_file . $page_params; ?>&paged=<?php print $page_count; ?>'><?php print $page_count; ?></a>
          <?php
        }
        ...
        {
          ?>
          <a class='next page-numbers' href='?page=<?php print AFLI_PLUGIN_NAME; ?>/<?php print $controller_file . $page_params; ?>&paged=<?php print($current_page + 1); ?>'>&raquo;</a>
          <?php
        }
        ?>
      </div>
